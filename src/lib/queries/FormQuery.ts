...
import { getFormFragment } from '$lib/utils/queryUtils.js';
...
export const getFormQuery = (handles: FieldProps['displayName'][] | undefined) => {
	const formFragment = getFormFragment(handles);
